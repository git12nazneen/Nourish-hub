...
//     try {
//       const response = await axios.get('http://localhost:5000/room'); // Assuming server is running on localhost:5000
...
//     e.preventDefault();
//     try {
//       const response = await axios.get(`http://localhost:5000/room/filter?price=${selectedPrice}`);

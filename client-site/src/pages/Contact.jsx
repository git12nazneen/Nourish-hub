...
const Contact = () => {
    ...
    <div class="container px-6 py-12 mx-auto">
        <div>
            <p class="font-medium text-yellow-500 dark:text-yellow-400">Contact us</p>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    <span class="inline-block p-3 text-yellow-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                    ...
                    <p class="mt-2 text-sm text-yellow-500 dark:text-blue-400">hello@merakiui.com</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                    <p class="mt-2 text-sm text-yellow-500 dark:text-blue-400">Start new chat</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-yellow-500 dark:text-yellow-400">100 Smith Street Collingwood VIC 3066 AU</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-yellow-500 dark:text-yellow-400">+1 (555) 000-0000</p>
                </div>
            </div>
            ...
            <div class="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                <form>
                    ...
                    <div class="w-full mt-4">
                        ...
                        <textarea class="block w-full h-32 px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
                    </div>

                    <button class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-yellow-500 rounded-lg hover:bg-yellow-400 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-opacity-50">
                        Send message
                    </button>
                </form>
            </div>
